      ...
      {backgroundUrl ? (
        <div className="relative h-32 overflow-hidden rounded-xl border border-gray-200">
          ...
          <button
            ...
            className="absolute right-2 top-2 rounded-full bg-white p-1 text-red-500 shadow hover:bg-gray-50"
          >
            <X className="h-4 w-4" />
          </button>
        </div>
      ) : (
        <label className="flex h-32 cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed border-gray-200 bg-gray-50 hover:bg-gray-100">
