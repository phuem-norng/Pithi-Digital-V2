    ...
    <div className="grid grid-cols-1 gap-6 md:grid-cols-2 md:grid-rows-2">
      <div className="rounded-lg border border-rose-100 p-4">
        <div className="relative flex h-40 flex-col items-center justify-center">
          ...
          <p className="text-sm text-slate-500">Animated pointer</p>
        </div>
        <Pointer>
          <motion.div
            animate={{
      ...
      <div className="rounded-lg border border-rose-100 p-4">
        <div className="relative flex h-40 flex-col items-center justify-center">
          ...
          <p className="text-sm text-slate-500">A custom pointer with different color</p>
        </div>
      ...
      <div className="rounded-lg border border-rose-100 p-4">
        <div className="relative flex h-40 flex-col items-center justify-center">
          ...
          <p className="text-sm text-slate-500">A pointer with a custom SVG shape</p>
        </div>
        <Pointer>
      ...
      <div className="rounded-lg border border-rose-100 p-4">
        <div className="relative flex h-40 flex-col items-center justify-center">
          ...
          <p className="text-sm text-slate-500">Using an emoji as a custom pointer</p>
        </div>
        <Pointer>
